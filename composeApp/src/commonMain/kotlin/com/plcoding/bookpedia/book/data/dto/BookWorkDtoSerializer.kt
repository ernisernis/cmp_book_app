...
object BookWorkDtoSerializer: KSerializer<BookWordDto> {
    override val descriptor: SerialDescriptor = buildClassSerialDescriptor(
        BookWordDto::class.simpleName!!
    ) {
    ...
    override fun deserialize(decoder: Decoder): BookWordDto = decoder.decodeStructure(descriptor) {
        ...
        return@decodeStructure BookWordDto(description)
    }
